package me.ialext.staff.api.database;
 ...
 */
public interface Repository<O extends SavableModel> {
   ...
   * stored in this {@link Repository}.
   *
   ...
   */
  default CompletableFuture<Void> replace(
      String id,
      O o
  ) {
